...
public class Motor implements Runnable{
	...
	public void run() {
		...
		//Robotti laskee esteradan selvitt‰miseen k‰ytetyn ajan. T‰ss‰ aloitetaan ajan laskeminen.
		...
		while (Data.shouldRun) {
			...
			//Jos ollaan viivalla, menn‰‰n suoraan	
	...
	public void obstacle()
	{
		...
		Delay.msDelay(3100);
		motorA.setPower(Data.SLOWDOWN);  //Hetki suoraan
		motorD.setPower(Data.SLOWDOWN);
		Delay.msDelay(3000);
